...
public class Main {
    ...
    public static void main(String[] args) throws InterruptedException {
        System.out.println("=== Version 2: ReentrantLock 版本 ===\n");

        FlashSaleServiceV2 service = new FlashSaleServiceV2();
    ...
    private static int runConcurrentTest(FlashSaleServiceV2 service, long productId, int threadCount)
